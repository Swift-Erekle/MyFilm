...
const PLAYER_FIXTURES = {
  ...
  'geofilms.net': '<script>setup({ sourceType: { source: "iframe" }, movie: "https://vsembed.ru/embed/movie/tt100" });</script>',
  'kinolab.cc': '<div data-load-embed="https://vidsrc-embed.ru/embed/movie/tt100"></div>',
